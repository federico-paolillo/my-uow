...
namespace FP.UoW.SQLite.Tests
{
    public class UoWServiceBuilderExtensionsTest
    {
        ...
        public void If_UoWServiceBuilder_instance_is_null_throws()
        {
            ...
            Assert.That(TryAddSQLiteToNullReference, Throws.ArgumentNullException);
        }
        ...
        public void Services_are_registered_as_expected(Type service, ServiceLifetime lifetime)
        {
            ...
            serviceCollection.AddUoW()
                .ForSQLite("random_connection_string_it_does_not_matter");
        ...
        public void Services_can_be_resolved()
        {
            ...
            var connectionString = serviceScope.ServiceProvider.GetRequiredService<SQLiteDatabaseConnectionString>();
    ...
    internal sealed class ServiceLifetimesTestData
    {
        public static IEnumerable Lifetimes
        {
            get
            {
                ...
                yield return new TestCaseData(typeof(SQLiteDatabaseConnectionString), ServiceLifetime.Singleton);
            }
        }
    }
}